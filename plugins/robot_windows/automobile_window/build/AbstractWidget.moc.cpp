/****************************************************************************
** Meta object code from reading C++ file 'AbstractWidget.hpp'
**
...
#error "The header file 'AbstractWidget.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 15, 24), // "updateEnableCheckBoxText"
QT_MOC_LITERAL(2, 40, 0) // ""

    },
    "AbstractWidget\0updateEnableCheckBoxText\0"
    ""
};
...
void AbstractWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AbstractWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AbstractWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_AbstractWidget.data,
    qt_meta_data_AbstractWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
